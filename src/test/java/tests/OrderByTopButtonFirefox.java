...
public class OrderByTopButtonFirefox {
    ...
    public OrderByTopButtonFirefox (String nameInput, String surnameInput, String addressInput, String stationNameInput, String phoneNumberInput, String dateOfDelivery, int rentalPeriod, String scooterColour, String comment) {
