...
public class OrderByBottomButtonChrome {
    ...
    public OrderByBottomButtonChrome (String nameInput, String surnameInput, String addressInput, String stationNameInput, String phoneNumberInput, String dateOfDelivery, int rentalPeriod, String scooterColour, String comment) {
    ...
    public void fullOrderTest() {
        ...
        String actualOrderConfirmedTitle = titleOrder.getText();
        Assert.assertEquals(expectedOrderConfirmedTitle, actualOrderConfirmedTitle);
